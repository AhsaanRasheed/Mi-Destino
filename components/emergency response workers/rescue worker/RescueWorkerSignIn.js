...
export default function RescueSigninmethod({ navigation }) {
    ...
    function login(){
        ...
        .then(() => {
            ...
            navigation.navigate('HomeRescueWorker')
        })
        .catch((error) => {
  ...
  return (
    ...
    <Text style={{paddingTop:10,fontSize:20,fontWeight:'bold', color:'#11c09f', marginTop:175}}>Rescue Worker Sign In</Text>
    </View>
