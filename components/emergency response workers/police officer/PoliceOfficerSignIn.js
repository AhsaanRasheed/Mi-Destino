...
export default function PoliceSigninmethod({ navigation }) {
    ...
    function login(){
        ...
        .then(() => {
            ...
            navigation.navigate('HomePoliceOfficer')
        })
  ...
  return (
    ...
    <Text style={{paddingTop:10,fontSize:20,fontWeight:'bold', color:'#11c09f', marginTop:175}}>Police Officer Sign In</Text>
    </View>
