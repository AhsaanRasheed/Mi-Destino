...
export default function HomePoliceOfficer({ navigation}) {
  ...
  return (
    ...
    <TouchableOpacity
         style={{
           ...
           onPress={() => navigation.navigate('PoliceCloseComplaints')}
           >
         <Text style={{fontSize:17, color: 'white'}}>Close Complaints</Text>
    </TouchableOpacity>   
    ...
    <TouchableOpacity
         style={{
           ...
           onPress={() => navigation.navigate('ViewPoliceClosedComplaints')}
           >
