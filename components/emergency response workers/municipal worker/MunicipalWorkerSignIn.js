...
export default function MunicipalSigninmethod({ navigation }) {
  ...
  return (
    ...
    <Text style={{paddingTop:10,fontSize:20,fontWeight:'bold', color:'#11c09f', marginTop:125}}>Municipal Worker Sign In</Text>
    </View>
