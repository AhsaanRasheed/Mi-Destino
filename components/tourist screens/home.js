...
export default function Homeapp({ navigation}) {
  ...
  return (
    ...
    <Text style={{paddingTop:20,fontSize:20,fontWeight:'bold',color:'#11c09f', paddingBottom:10}}>
    Welcome To Mi Destino    
    </Text>
    ...
    <TouchableOpacity
         style={{
           ...
           >
         <Text style={{fontSize:17, color: 'white'}}> Search Products</Text>
    </TouchableOpacity>
