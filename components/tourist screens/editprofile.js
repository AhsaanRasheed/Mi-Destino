...
export default function EditprofileN({ navigation}) {
  ...
  .then(documentSnapshot => {
    ...
    if (documentSnapshot.exists) {
      ...
      setNewCity(documentSnapshot.data().city)
      setNewAddress(documentSnapshot.data().address)
      //console.log(name)
    }
  }); }
  ...
  return (
    ...
    <View style={{paddingTop:10}}>
    <Text style={{marginLeft:38,fontSize:15,fontWeight:'bold', color:'#11c09f', marginBottom:10}}>Enter City:</Text>
    <TextInput
        style={{height: 40,borderWidth:2,marginLeft:35,marginRight:35,borderColor:'#11c09f',borderRadius:20,color:'black', paddingLeft:15}}
        placeholder="Enter City Here"
        placeholderTextColor={'black'}
        onChangeText={(val)=> setNewCity(val)}></TextInput>      
    </View>

    <View style={{paddingTop:10}}>
    <Text style={{marginLeft:38,fontSize:15,fontWeight:'bold', color:'#11c09f', marginBottom:10}}>Enter Address:</Text>
    <TextInput
        style={{height: 40,borderWidth:2,marginLeft:35,marginRight:35,borderColor:'#11c09f',borderRadius:20,color:'black', paddingLeft:15}}
        placeholder="Enter Address Here"
        placeholderTextColor={'black'}
        onChangeText={(val)=> setNewAddress(val)}></TextInput>      
    </View>
