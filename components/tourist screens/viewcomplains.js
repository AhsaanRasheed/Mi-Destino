...
import { Button,Text,TextInput, View, StyleSheet,TouchableOpacity ,Alert, ActivityIndicator,FlatList, ScrollView} from 'react-native';
    ...
    <View >
            ...
            renderItem={({ item }) => {
              ...
              return(
                ...
                <View style={{marginTop:18, borderColor:'#11c09f', borderWidth:2, marginRight:70, borderRadius:15, height:70, paddingLeft:10, marginLeft:70}}>
