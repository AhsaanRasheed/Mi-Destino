...
function getdata(){    
  ...
  return (
    ...
    <TextInput style = {{borderWidth:2, marginLeft:1, marginRight:30, marginTop:10, paddingLeft:5, borderColor:'#11c09f', color:"black"}} value = {Location} onChangeText = {setLocation} />

    <Text style={{fontSize: 15, fontWeight: 'bold', color:'#11c09f'}}>Complaint Details:</Text>
    <TextInput multiline = {true} style = {{borderWidth:2, marginLeft:1, marginRight:30, marginTop:10, paddingLeft:5, borderColor:'#11c09f' , color:"black"}} value = {Description} onChangeText = {setDescription} />

    <Text style={{fontSize: 15, fontWeight: 'bold', color:'#11c09f'}}>Time Stamp:</Text>
    <TextInput style = {{borderWidth:2, marginLeft:1, marginRight:30, marginTop:10, paddingLeft:5, borderColor:'#11c09f' , color:"black"}} value = {timestamp} onChangeText = {setTimestamp} />
